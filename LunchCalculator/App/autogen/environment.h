...
Q_IMPORT_QML_PLUGIN(LunchCalculatorPlugin)
Q_IMPORT_QML_PLUGIN(LunchCalculatorContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/LunchCalculatorContent/App.qml";
